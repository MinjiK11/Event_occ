...
def parse_args():
    ...
    #parser.add_argument('--config', help='train config file path', default='VoxFormer/projects/configs/voxformer/Voxformer-S_ev.py')
...
def main():
    ...
    custom_train_model( # train model -> runner
        model,
        datasets,
        cfg,
